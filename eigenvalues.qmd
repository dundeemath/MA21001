...
::: {.Corollary #eigenvaluestriangular #eigentriangular}
...
$$A = \left[\begin{array}{cccc}
            ...
            5 & 7 & 4 & -2
        \end{array}\right]$$
has eigenvalues $\lambda _{1} = 2, \lambda _{2} = 1, \lambda _{3} = 3$ and $\lambda _{4} = -2$, by Corollary \ref{eigentriangular}. Since these are four distinct
