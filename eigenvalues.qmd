...
::: {.Proof}
Let ${\rm A}$ be diagonalisable. Then ${\rm A}$ has an eigenbasis $\vec{x}_i, i=1..n$. For simplicity we first assume that there are $n$ distinct eigenvalues, but one also prove the theorem for repeated eigenvalues.  
