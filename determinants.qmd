...
- $8) \Leftrightarrow 9):$ We know from 4) that the range is the whole of $\mathbb{R}^n$ and if the solutions were not unique then there would be non-trivial solutions in the nullspace. (assume two different $\vec{x}} map to the same $\vec{b}$: ${\rm A}\vec{x}_1= \vec{b}$ and ${\rm A}\vec{x}_2= \vec{b}$ then ${\rm A}(\vec{x}_1  -\vec{x}_2)= \vec{0}$ and $(\vec{x}_1  -\vec{x}_2)$ would be a non-trivial vector in the nullspace.
