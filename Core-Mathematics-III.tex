...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Remark on Notation}, opacityback=0, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Advanced material}, opacityback=0, arc=.35mm]
...
of \(\mathbb{R}^{3}\), the set of vectors
\(\left\{(1,0,0,0)^{T}, (0,1,0,0)^{T},\right\}\)\\
\(\left (0,0,1,0)^{T},(0,0,0,1)^{T}\right\}\) forms a basis of
\(\mathbb{R}^{4}\) and so on. This is called the \textbf{standard basis}
of \(\mathbb{R}^{n}\) for \(n\in\mathbb{N}\).
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Remark on dimension}, opacityback=0, arc=.35mm]
...
space. Similar, \(n+1\) vectors in \(\mathbb{R}^{n}\) must be linearly
dependent. If they were linearly independent they could form a basis
with more than \(n\) elements. Again this can't be true, hence they are
linearly dependent.~◻
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Remark}, opacityback=0, arc=.35mm]
...
\begin{array}{rrr}
 1 &  2 & 5  \\
  3 & 4  &   -7
  \end{array}
\right) \in M_{2\times3} ,  \quad A_{12} =2 .\]

\end{example}

\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Notation}, opacityback=0, arc=.35mm]
...
general entry: \({\rm A}=\left[ a_{ij}\right]\).
...
\[{\rm A} + {\rm B}=[a_{ij}] + [b_{ij}]= [ a_{ij}+b_{ij}], \] and the
scalar multiplication by \[c {\rm A} = c [a_{ij}] = [ c a_{ij}] .\]
...
addition is the negative matrix \(-{\rm A} = [-a_{ij}]\). The two
...
matrix~\(P\), where
\[p_{i,j}  = g_{i,1}h_{1,j}+g_{i,2}h_{2,j}+\dots+g_{i,r}h_{r,j} = \sum_{s=1}^r g_{is}h_{sj}\]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-warning-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, opacityback=0, arc=.35mm]
...
\phantomsection\label{transpose-of-a-matrix}
If \(A=[a_{ij} ]\) is an \(m\times n\) matrix, then the transpose of
...
\item
  \[\left( ({\rm A} + {\rm B})^{T}\right)_{ij} =  ({\rm A} + {\rm B})_{ji} = a_{ji} + b_{ji}  = ({\rm A}^{T})_{ij} + ({\rm B}^{T})_{ij}\]
\item
...
\({\rm A}\) is said to be skew-symmetric or anti-symmetric.
...
\begin{equation}\phantomsection\label{eq-symdecomp}{{\rm A} = \frac{{\rm A}^{T}+{\rm A}}{2} + \frac{{\rm A}- {\rm A}^{T}}{2} ,}\end{equation}
noting that \((A^{T}+A)/2\) is symmetric, and
\(({\rm A}- {\rm A}^{T} )/2\) is skew-symmetric.

\begin{example}[]\protect\hypertarget{exm-}{}\label{exm-}

Example for a symmetric and a skew-symmetric matrix.
\[ {\rm A}= \left( \begin{array}{rrr}
 1  & 0  & {-4}  \\
 0  & 2  & 5  \\
 -4  & 5  & 3  
\end{array}  \right) = {\rm A^T}; \quad  {\rm A} = \left(\begin{array}{rrr}
 0  & 1  & {-4}  \\
 -1  & 0  & 5  \\
 4  & -5  & 0  
\end{array}  \right) = (- {\rm A}^T).\] Note that a skew symmetric
matrix has to have zeros on the diagonal.

\end{example}

\begin{example}[]\protect\hypertarget{exm-}{}\label{exm-}

Example for the decomposition Equation~\ref{eq-symdecomp}.
\[\left( \begin{array}{rrr}
 2  & 0  & {-4}  \\
 {-2}  & 2  & 0  \\
 2  & 4  & 6  
...
There exists a neutral element, \({\rm I} \in M_{n\times n}\),
w.r.t.\textasciitilde the matrix multiplication, called the identity
matrix for the multiplication, which consists of 1's down the main
diagonal and 0's everywhere else: \[{\rm I} =  \begin{pmatrix}
          1 &0  &\ldots   &0  \\
          0 &1  &   &\vdots   \\
           \vdots  &   & \ddots  &0 \\
          0   &  \ldots &  0&1
...
means: \[\begin{aligned}
{\rm A} {\rm I} & = {\rm A}  \quad \text{and} \quad  {\rm I}  {\rm A} = {\rm A}  \quad \text{for} \ {\rm A} \in M_ {m\times r}.
...
\[{\rm I}{\rm A} =\left(\begin{array}{rrr}
 1  & 0  & 0  \\
 0  & 1  & 0  \\
 0  & 0  & 1  
...
\end{array}  \right) = \left( \begin{array}{rr}
 ...
 3  & 4   \\
 5  & 6    
\end{array}  \right)= {\rm A}.\]

\[{\rm A}{\rm I} =\left(\begin{array}{rr}
 1  & 2  \\
 3  & 4   \\
 5  & 6    
\end{array}  \right)\left(\begin{array}{rr}
...
\phantomsection\label{inverse-of-a-matrix}
If two matrices \({\rm A}\) and \({\rm B}\) satisfy
\[{\rm A} {\rm B} = {\rm B}  {\rm A} = {\rm I}\] then
\({\rm B} = {\rm A}^{-1}\) is called the inverse of \({\rm A}\) (and
vice versa \({\rm A}\) is the inverse of \({\rm B}\)). If \({\rm A}\)
has an inverse, it is said to be non-singular. Any matrix which does not
have an inverse is said to be singular.

\end{fbxSimple}

\phantomsection\label{only-square-matrices-have-an-inverse}
\begin{fbxSimple}{Corollary}{Corollary 3.10: }{Only square matrices have an inverse}
\phantomsection\label{only-square-matrices-have-an-inverse}
The definition above requires \({\rm A}{\rm B} = {\rm B}  {\rm A}\),
which implies that \({\rm A}\) and \({\rm B}\) are square matrices of
the same size. Hence only square matrices can have an inverse (see also
remark \ref{nte-nonsquare}).
...
Assume \({\rm A} \in M_{m\times r}\) and \({\rm B} \in M_{s\times n}\),
then for \({\rm A}{\rm B}\) to be defined we have to have \(r=s\) and
for \({\rm B A}\) to be defined \(m=n\). Furthermore
\({\rm A B}= {\rm B A}\) requires \(m=n\).

\end{fbx}

\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Remark}, opacityback=0, arc=.35mm]

Note that we have to require both \({\rm A} {\rm B} ={\rm I}\) and
\({\rm B} {\rm A}={\rm A} {\rm B}\) since the matrix product is not
commutative. Below is an example that \({\rm A} {\rm B} ={\rm I}\) alone
is not sufficient to guarantee that \({\rm B}\) is the inverse of
\({\rm A}\). Alternatively we can demand that both matrices are square
matrices, \({\rm A},{\rm B}\in M_{n\times n}\), then
\({\rm A} {\rm B} ={\rm I}\) is enough to show that \({\rm B}\) is the
inverse of \({\rm A}\). The proof uses the fact that square matrices
have determinants and \({\rm A} {\rm B} ={\rm I}\) implies that the
determinants of both matrices are non-zero. Hence both matrices have
inverses and multiplying \({\rm A} {\rm B} ={\rm I}\) from the left with
\({\rm A}^{-1}\) yields \({\rm B} = {\rm A}^{-1}\).

\end{tcolorbox}

\begin{example}[]\protect\hypertarget{exm-}{}\label{exm-}

Check that \({\rm A}{\rm B}= {\rm I}\) and \({\rm B}{\rm A} = {\rm I}\)
and thus \({\rm B} = {\rm A}^{-1}\). \[{\rm A}=\left[ \begin{array}{ccc}
 2 & 0 & 1 \\
 1 & {-2} & 1 \\
 3 & 1 & 1 
\end{array}  \right], \quad 
{\rm B}=\left[ \begin{array}{ccc}
 {-3} & 1 & 2 \\
 2 & {-1} & {-1} \\
 7 & {-2} & {-4}
\end{array}  \right]\]
...
Check that \({\rm A}{\rm B}= {\rm I}\), but
\({\rm B}{\rm A} \neq {\rm A}{\rm B}\) and thus \({\rm B}\) is not the
inverse of \({\rm A}\). \[{\rm A}=\left[ \begin{array}{ccc}
 1 & 0 & 0 \\
 0 & 1 & 0 
\end{array}  \right], \quad 
{\rm B}=\left[ \begin{array}{ccc}
...
\phantomsection\label{inverse-of-transpose-and-product}
\begin{fbxSimple}{Corollary}{Corollary 3.11: }{Inverse of Transpose and Product}
\phantomsection\label{inverse-of-transpose-and-product}
...
In the previous sections, we encountered systems of equations of the
type \[a_{1} x_{1} + a_{2} x_{2}  + ... + a_{n} x_{n} = d.\] In the
following, we will use a method called Gaussian elimination to determine
solutions.
...
x+y & = 2 \\
2x + 3y  & = 1.
\end{aligned} \right.\] We use the curly bracket to remind us that this
is a system, and that we need to solve both equations simultaneously.
Usually we would solve the system by solving e.g.~the first equation for
\(x\) and substituting the result in the second equation:
...
The result \(y=-3\) is then substituted back in the other equation, and
we find \(x=5\). When it comes to systems with large numbers of
variables and equations, this approach becomes increasingly hard to
follow, and we need a more systematic approach. Note that the second
line above can be understood as the result of subtracting twice the
first equation from the second equation in the original system. That is,
we converted the system \[ \left\{\begin{aligned}
x+  y &= 2  \\
2x + 3y  &=  1 
\end{aligned} \right. \quad \stackrel{eq.2 - 2\, eq.1}{\Longrightarrow} \left\{\begin{aligned}
x + y  &=  2 \\
      y &= -3 \  
\end{aligned} \right. \] into an equivalent system by subtracting
equations. "Equivalent" here means that both systems have the same
solutions. This system is now trivial to solve. Operations which lead to
equivalent systems are, e.g., multiplying an equation by a (non-zero)
number and, as we have seen above, adding multiples of other equations.
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note \ref*{nte-effectivegauss}}, opacityback=0, arc=.35mm]

\quartocalloutnte{nte-effectivegauss} 

To avoid making unnecessary steps when applying row operations it is
good to follow a scheme. First, if your first row starts with a zero
swap it for another row that starts with a non-zero number (ideally a
small integer). Second, use row operations to obtain zeros in the
positions indicated below, starting in column one, row 2, and working
your way to the end of the column before moving to column 2, row 3, and
so on, as indicated in this matrix. Each time you subtract or add a
multiple of row with the red element in the column to obtain zeros.
\[\begin{array}{llll|r}
 {\color{red}\star} &  \star& \star & \star & \star  \\
 \star_1 &  {\color{red}\star} & \star & \star & \star  \\
 \star_2 &  \star_4 & {\color{red}\star}  & \star & \star  \\
 \star_3 &  \star_5 & \star_6 & \star & \star     
\end{array}\] If in this process one of the red element is already zero,
swap the row with a row below so that you get a non-zero element in the
position of the red stars. This method avoids that you destroy zeros you
already achieved by subsequent row operations. Below an example which
does \textbf{not} follow this scheme and destroys existing zeros.
\[\begin{array}{rrr|r}
  1 & 2& 1 &1 \\
   2& 1 & 1  & 2 \\
    1 & 3 & 3 & -3    
\end{array}
\stackrel{R_2-2\, R_1}{\Longrightarrow}
\begin{array}{rrr|r}
  1 & 2& 1 &1 \\
   0& -3 & -1  & 0 \\
    1 & 3 & 3 & -3    
\end{array}\] \[\stackrel{R_3 + R_2}{\Longrightarrow}
\begin{array}{rrr|r}
  1 & 2& 1 &1 \\
   0& -3 & -1  & 0 \\
     1 & 0 & 2 & -3 
...
\begin{array}{rrr|r}
  1 & 0& 1 &1 \\
   0& -3 & -1  & 0 \\
     0 & -2 & 1 & -4 
\end{array}\] In the last step we destroyed the zero in column , row 3,
which we already had before, in order to get the one in column 1, row 3.
...
1  &   -2& 3 & 4  & 10 \\
2 & 2 & -3 & -3 & -3    
\end{array}  \quad \stackrel{\small \begin{array}{l} r_2-2 r_1 \\  r_3- r_1\\  r_4- 2 r_1 \end{array}}{\Longrightarrow} \quad 
 \begin{array}{rrrr|r}
 1 &   1& -1 & 2& 12  \\
0&   -3 & 3& -5 &-29 \\
 0&  -3& 4 & 2  & -2 \\
  0&  0 &-1 & -7 & -27    
\end{array} \\
&\stackrel{r_3-r_2}{\Longrightarrow}& \begin{array}{rrrr|r}
 1 &   1& -1 & 2& 12  \\
0&   -3 & 3& -5 &-29 \\
0& 0 & 1 & 7  & 27 \\
0& 0 & -1 & -7 & -27    
\end{array} \qquad \stackrel{r_4+r_3}{\Longrightarrow} \qquad \begin{array}{rrrr|r}
1 &   1& -1 & 2& 12  \\
0&   -3 & 3& -5 &-29 \\
0& 0 & 1 & 7  & 27 \\
0 & 0 & 0 &  0 & 0    
...
\begin{example}[Overdetermined
system]\protect\hypertarget{exm-ge3}{}\label{exm-ge3}
...
\begin{array}{rrr|r}
  1 & 0& 1 &1 \\
   0& 1 & 1  & 2 \\
    0 & 0 & 0 & -8    
\end{array}\] In this case, the last equation states:
\(0\, x + 0\, y + 0\, z=-8\), which is impossible to satisfy for any
\(x,y\) or \(z\). This case often occurs if there are more equations
than variables.

\end{example}

\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Additional material: Geometric interpretation}, opacityback=0, arc=.35mm]
...
The left figure is the situation in Example Example~\ref{exm-ge3}. The
three hyperplanes intersect in three parallel lines. The right figure
shows the situation of three linearly independent hyperplanes in {ℝ3}
which have one point in common. This is situation 1.
...
\phantomsection\label{Definition-3.12}
\begin{fbxSimple}{Definition}{Definition 3.12}{}
\phantomsection\label{Definition-3.12}
...
\begin{fbxSimple}{Corollary}{Corollary 3.13: }{Inverse of elementary matrices}
\phantomsection\label{inverse-of-elementary-matrices}
The elementary matrices are nonsingular, i.e.~they have an inverse.
...
\({\rm E}_i\), that converts a square matrix \({\rm A}\) into an
identity matrix.
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, arc=.35mm]

To avoid making unnecessary steps when applying row operations it is
good to follow the scheme explained in Note~\ref{nte-effectivegauss} and
go on to insert zeros also above the diagonal following the sequence
indicated below. \[\begin{array}{llll|r}
 {\color{red}\star} &  \star_{12} & \star_{11} & \star_9 & \star  \\
 \star_1 &  {\color{red}\star} & \star_{10} & \star_8 & \star  \\
 \star_2 &  \star_4 & {\color{red}\star}  & \star_7 & \star  \\
 \star_3 &  \star_5 & \star_6 & {\color{red}\star}  & \star     
\end{array}\]
...
\begin{fbxSimple}{Definition}{Definition 3.14: }{Upper/Lower Triangular Matrix}
\phantomsection\label{upperlower-triangular-matrix}
...
Consider a system of linear equations, \(A\vec{x} = \vec{y}\) where
\(A\) is an \(m \times n\) matrix. We can consider the matrix \(A\) as a
mapping from the space of all \(\vec{x}\) vectors in \(\mathbb{R}^{n}\)
onto the space of all possible \(\vec{y}\) vectors, which is a subset of
\(\mathbb{R}^{m}\).
\[A: \vec{x} \in \mathbb{R}^{n} \longrightarrow \vec{y} = A \vec{x} \in \mathbb{R}^{m}\].

\phantomsection\label{range-and-rank}
\begin{fbxSimple}{Definition}{Definition 3.15: }{Range and Rank}
\phantomsection\label{range-and-rank}
...
Note first that the range of \({\rm A}\in M_{m\times n}\), that is all
the vectors in \(\mathbb{R^m}\) that are an image of a vector in
\(\mathbb{R^n}\) can be written as
\[ {\rm range(A)} = \left\{ \vec{y} \in \mathbb{R}^m | \vec{y}={\rm A} \vec{x}; \ \vec{x} \in  \mathbb{R}^n \right\}. \]
The vectors \(\vec{x} \in \mathbb{R}^n\) can be represented w.r.t. the
standard basis:
\[  \vec{x} = x_1 \vec{e}_1 +  x_2 \vec{e}_2 + ... +  x_n \vec{e}_n. \]
The image of these vectors under \({\rm A}\) is
\[ {\rm A} \vec{x} = {\rm A} (x_1 \vec{e}_1 +  x_2 \vec{e}_2 + ... +  x_n \vec{e}_n) = x_1 {\rm A}\vec{e}_1 +  x_2 {\rm A}\vec{e}_2 + ... +  x_n {\rm A}\vec{e}_n.\]
The vector \({\rm A}\vec{e}_i\) is the i-th column of \({\rm A}\), hence
the image of \(\vec{x}\) is a linear combination of the columns of
\({\rm A}\). Thus
\[ {\rm range(A)} = \left\{ \vec{y} \in \mathbb{R}^m | \vec{y}={\rm A} \vec{x}; \ \vec{x} \in  \mathbb{R}^n \right\} = {\rm span} \left(\text{columns of A} \right).\]

Furthermore \({\rm range(A)}\) is a subspace of \(\mathbb{R}^m\) since:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  \(\vec{0} = {\rm A} (\vec{0}) \in {\rm range(A)}\)
\item
  if
  \(\vec{y}_1={\rm A} (\vec{x}_1), \vec{y}_2 = {\rm A} (\vec{x}_2) \in {\rm range(A)}\)
  then
  \[\vec{y}_1 + \vec{y}_2 = {\rm A} (\vec{x}_1)+{\rm A} (\vec{x}_2) = {\rm A} (\vec{x}_1 + \vec{x}_2) \in {\rm range(A)}\]
\item
  if \(c\in \mathbb{R}\) and \(\vec{y}={\rm A} (\vec{x})\) then
  \(c \vec{y}= c {\rm A} (\vec{x}) = {\rm A} (c \vec{x}) \in {\rm range(A)}.\)
\end{enumerate}
...
\phantomsection\label{Solutionux2a-3.4}
\begin{fbx}{Solution}{Solution}{}
\phantomsection\label{Solution*-3.4}
...
independent. A test for linear independence,
...
leads to \[ \Rightarrow \left\{\begin{array}{l}
 c_1+2 c_2+3 c_3=0 \\
 2 c_1+ 3 c_2+ 4 c_3=0 
...
In order for \(\vec{y}=A \vec{x}\) to have a solution \(\vec{x}\),
\(\vec{y}\) has to be in the range of \({\rm A}\):
\(\vec{y} \in {\rm range}(A)\). Let \[A = \left(\begin{array}{ccc}
            1 & 0 & 1 \\
            1 & 1 & 3 \\
            0 & 1 & 2
        \end{array}\right); \quad \text{and} \quad (i) \quad  \vec{y} = \begin{pmatrix} 1 \\ 1 \\ 1  \end{pmatrix}; \quad  (ii) \quad \vec{y}= \begin{pmatrix} 1 \\ 2 \\ 1  \end{pmatrix}. \]

Check whether the system \(A\vec{x}=\vec{y}\) is consistent.

Under what general conditions on
\(\vec{y} = \left(y_1,y_2, y_3\right)^T\) is the system consistent?

\begin{fbx}{Solution}{Solution}{}
\phantomsection\label{}
\[{\rm range(A)}= {\rm span} \left( \begin{pmatrix} 1 \\ 1 \\ 0  \end{pmatrix} , \begin{pmatrix} 0 \\ 1 \\ 1  \end{pmatrix},\begin{pmatrix} 1 \\ 3 \\2 \end{pmatrix} \right)\]
However, the three columns of \({\rm A}\) are not linearly independent.
Indeed
\[ a \begin{pmatrix} 1 \\ 1 \\ 0  \end{pmatrix} + b \begin{pmatrix} 0 \\ 1 \\ 1  \end{pmatrix}+ c \begin{pmatrix} 1 \\ 3 \\2 \end{pmatrix} = \begin{pmatrix} 0 \\ 0 \\0 \end{pmatrix} \]
has non-trival solutions, e.g.~\(a=1, b=2,c=-1\).\\
Hence, for example, the first two columns alone span
\({\rm range}(A)\)\\
\[{\rm range(A)}= {\rm span} \left( \begin{pmatrix} 1 \\ 1 \\ 0  \end{pmatrix} , \begin{pmatrix} 0 \\ 1 \\ 1  \end{pmatrix}\right),\]
and a general element in the range is
\[\vec{y} =  a \begin{pmatrix} 1 \\ 1 \\ 0  \end{pmatrix} + b \begin{pmatrix} 0 \\ 1 \\ 1  \end{pmatrix}=\begin{pmatrix} a \\ a+b \\ b  \end{pmatrix}.\]
So \(\vec{y} = \left(1,2,1\right)^T\) is in the range, but
\(\vec{y} = \left(1,1,1\right)^T\) is not. Note that the first and the
third columns of \(A\) also span \({\rm range}(A)\). Even the last two
columns can be used.
...
\begin{fbxSimple}{Definition}{Definition 3.16: }{Nullspace and Nullity}
\phantomsection\label{nullspace-and-nullity}
Let \(A\) be an \(m \times n\) matrix. The nullspace of \(A\), is the
set of vectors \({\bf x}\) such that \(A\vec{x} = \vec{0}\). The
...
\begin{fbxSimple}{Corollary}{Corollary 3.17: }{Nullspace is a subspace}
\phantomsection\label{nullspace-is-a-subspace}
...
\def\labelenumi{(\roman{enumi})}
\item
  Since \(A\vec{0_n} = \vec{0_m},  \vec{0_n} \in {\rm Null}(A)\).
\item
  Let \(\vec{u}\) and \(\vec{v}\) be in \({\rm Null}(A)\). Therefore
  \(A\vec{u} = \vec{0}\) and \(A\vec{v} = \vec{0}\). It follows that
  \(A(\vec{u} + \vec{v}) = A\vec{u} + A\vec{v}  = \vec{0} + \vec{0} = \vec{0}\)
  Hence, \(\vec{u} + \vec{v} \in {\rm Null}(A)\).
\item
  Finally, for any scalar \(\lambda\),
  \(A(\lambda \vec{u}) = \lambda (A\vec{u}) = \lambda \vec{0} = \vec{0}\)
  and therefore \(\lambda \vec{u} \in {\rm Null}(A)\). It follows that
  \({\rm Null}(A)\) is a subspace of \(\mathbb{R}^{n}\). ~◻
\end{enumerate}
...
\phantomsection\label{Solutionux2a-3.6}
\begin{fbx}{Solution}{Solution}{}
\phantomsection\label{Solution*-3.6}
\[ {\rm A} \vec{x} = \left(\begin{array}{ccc}
            1 & 2 & 3 \\
            2 & 3 & 4 
...
\begin{fbxSimple}{Definition}{Definition 3.18: }{Row and column space}
\phantomsection\label{row-and-column-space}
...
\begin{fbxSimple}{Theorem}{Theorem 3.19: }{Dimension of row and column spaces}
\phantomsection\label{rowcolumnspace}
...
\phantomsection\label{Proofux2a-3.8}
\begin{fbx}{Proof}{Proof}{}
\phantomsection\label{Proof*-3.8}
...
\(n-\gamma\) free variables in the solution to \(A\vec{x} = \vec{0}\).
Since \({\rm dim}({\rm Null}(A)) = n - \gamma\), we have
...
\phantomsection\label{Solutionux2a-3.9}
\begin{fbx}{Solution}{Solution}{}
\phantomsection\label{Solution*-3.9}
...
the row space and the use Theorem \hyperref[rowcolumnspace]{3.19} for
...
\({\rm rank}(A) = 3\).\\
Solving the equation \(A\vec{x} = \vec{0}\), we see that all solutions
are of the form \(\vec{x} = c \left[1, 1, 1, -1 \right]^{T}\), so that
the dimension of the nullspace is \(1\). Thus,
...
\[\vec{x} = r \left[\begin{array}{c} 1 \\ -1 \\ 1 \\ 0 \\ 0 \end{array}\right] + s \left[\begin{array}{c} 1 \\ -2 \\ 0 \\ 1 \\ 0 \end{array}\right] + t \left[\begin{array}{c} -1 \\ 0 \\ 0 \\ 0 \\ 1 \end{array}\right]\]
...
\item
  ...
  \(R\vec{x} = \vec{0}\) in terms of the free variables (\(x_3, x_4\)
  and \(x_5\) in the example).
\item
  Set the free variables equal to parameters, substitute back into
  \(\vec{x}\), and write the results as a linear combination of \(f\)
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note \ref*{nte-nonsquare}: Remark: Nullspace of non-square matrices}, opacityback=0, arc=.35mm]
...
row space are the same (Theorem \hyperref[rowcolumnspace]{3.19}). Then
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Remember}, opacityback=0, arc=.35mm]
...
\phantomsection\label{Corollary-5.6}
\begin{fbxSimple}{Corollary}{Corollary 5.6}{}
\phantomsection\label{Corollary-5.6}
If \(A\) is an \(n \times n\) matrix, then the geometric multiplicity of
each eigenvalue is at least 1 and less than or equal to its algebraic
multiplicity.
\[ 1 \le {\rm dim( E_\lambda)\le \text{\small algebraic multiplicity}}\]

\end{fbxSimple}

\phantomsection\label{eigenvaluestriangular}
\begin{fbxSimple}{Corollary}{Corollary 5.7}{}
\phantomsection\label{eigenvaluestriangular}
...
\hyperref[eigenvaluestriangular]{5.7}.

\phantomsection\label{eigenlinind}
\begin{fbxSimple}{Theorem}{Theorem 5.8}{}
\phantomsection\label{eigenlinind}
...
\begin{fbxSimple}{Definition}{Definition 5.9: }{Similar Matrices}
\phantomsection\label{similar-matrices-1}
...
\begin{fbxSimple}{Theorem}{Theorem 5.10: }{Properties of Similar Matrices}
\phantomsection\label{simmatrices}
...
theorem \hyperref[ranktheorem]{3.20} to show that this also implies that
rank(A)=rank(B).
...
Theorem \hyperref[simmatrices]{5.10} is helpful in showing that two
...
\begin{fbxSimple}{Definition}{Definition 5.11: }{Diagonalisable Matrices}
\phantomsection\label{diagonalisable-matrices}
...
\begin{fbxSimple}{Theorem}{Theorem 5.12: }{Condition for Diagonalisability}
\phantomsection\label{diagifind}
...
There we find that the eigenvalues of \(A\) are \(\lambda _{1} = 2\) and
...
By theorem \hyperref[eigenlinind]{5.8}, the eigenvectors to different
eigenvalues are linearly independent. Together with the information that
each eigenspace has a basis of (linearly independent) eigenvectors we
obtain that the set \(B\) must be linearly independent. ◻

\end{fbx}

\phantomsection\label{eigendiag}
\begin{fbxSimple}{Theorem}{Theorem 5.14}{}
\phantomsection\label{eigendiag}
...
By theorem \hyperref[eigenlinind]{5.8},
\(\mathbf{v_{1}}, \mathbf{v_{2}}, \cdots, \mathbf{v_{n}}\) are linearly
independent, so, by Theorem \hyperref[diagifind]{5.12}, \(A\) is
diagonalisable.~◻
...
\hyperref[eigenvaluestriangular]{5.7}. Since these are four distinct
eigenvalues for a \(4 \times 4\) matrix, \(A\) is diagonalisable, by
Theorem \hyperref[eigendiag]{5.14}.

\end{example}

\phantomsection\label{joint-eigenbasis}
\begin{fbxSimple}{Theorem}{Theorem 5.15: }{Joint eigenbasis}
\phantomsection\label{joint-eigenbasis}
...
\(n\) distinct eigenvalues, but one can also prove the theorem for
...
\begin{fbxSimple}{Definition}{Definition 5.16: }{(Hermitian) Adjoint Operator}
\phantomsection\label{hermitian-adjoint-operator}
...
\begin{fbxSimple}{Corollary}{Corollary 5.17: }{Properties of the hermitian adjoint}
\phantomsection\label{properties-of-the-hermitian-adjoint}
...
\begin{fbxSimple}{Corollary}{Corollary 5.18: }{Orthogonal eigenbasis}
\phantomsection\label{orthogonal-eigenbasis}
...
\phantomsection\label{Proofux2a-5.13}
\begin{fbx}{Proof}{Proof}{}
\phantomsection\label{Proof*-5.13}
